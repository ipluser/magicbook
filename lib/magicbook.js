;(function (global, $) {  // eslint-disable-line
  ...
  var Magicbook = global.Magicbook = function Magicbook(cfg) {
    ...
    self.handler('drawUtilities', self.drawUtilities, {
      priority: 1
    });
  ...
  proto.drawUtilities = function drawUtilities() {
    var self = this;
    var utilities = self.config.utilities;
    ...
    if (utilities.flip) {
      ...
      $contentWrap.append($flip.append($pre).append($next));
    }
  };
